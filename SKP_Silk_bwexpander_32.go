...
func SKP_Silk_bwexpander_32(ar *int32, d int32, chirp_Q16 int32) {
	...
	*(*int32)(unsafe.Add(unsafe.Pointer(ar), unsafe.Sizeof(int32(0))*uintptr(int64(d)-1))) = SKP_SMULWW(*(*int32)(unsafe.Add(unsafe.Pointer(ar), unsafe.Sizeof(int32(0))*uintptr(int64(d)-1))), tmp_chirp_Q16)
}
