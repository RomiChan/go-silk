...
func SKP_Silk_resampler_private_up4(S *int32, out *int16, in *int16, len_ int32) {
	...
	for k = 0; int64(k) < int64(len_); k++ {
		...
		*(*int32)(unsafe.Add(unsafe.Pointer(S), unsafe.Sizeof(int32(0))*0)) = int32(int64(in32) + int64(X))
		out16 = SKP_SAT16(int16(SKP_RSHIFT_ROUND(out32, 10)))
		*(*int16)(unsafe.Add(unsafe.Pointer(out), unsafe.Sizeof(int16(0))*uintptr(int64(k)*4))) = out16
		*(*int16)(unsafe.Add(unsafe.Pointer(out), unsafe.Sizeof(int16(0))*uintptr(int64(k)*4+1))) = out16
		...
		*(*int32)(unsafe.Add(unsafe.Pointer(S), unsafe.Sizeof(int32(0))*1)) = int32(int64(in32) + int64(X))
		out16 = SKP_SAT16(int16(SKP_RSHIFT_ROUND(out32, 10)))
		*(*int16)(unsafe.Add(unsafe.Pointer(out), unsafe.Sizeof(int16(0))*uintptr(int64(k)*4+2))) = out16
		*(*int16)(unsafe.Add(unsafe.Pointer(out), unsafe.Sizeof(int16(0))*uintptr(int64(k)*4+3))) = out16
	}
}
