...
func SKP_Silk_resampler_down3(S *int32, out *int16, in *int16, inLen int32) {
	...
	for {
		...
		counter = nSamplesIn
		for int64(counter) > 2 {
			res_Q6 = SKP_SMULWB(int32(int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*0)))+int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*5)))), int32(SKP_Silk_Resampler_1_3_COEFS_LQ[2]))
			res_Q6 = SKP_SMLAWB(res_Q6, int32(int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*1)))+int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*4)))), int32(SKP_Silk_Resampler_1_3_COEFS_LQ[3]))
			res_Q6 = SKP_SMLAWB(res_Q6, int32(int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*2)))+int64(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*3)))), int32(SKP_Silk_Resampler_1_3_COEFS_LQ[4]))
			*func() *int16 {
				p := &out
				x := *p
