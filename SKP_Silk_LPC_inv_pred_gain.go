...
func LPC_inverse_pred_gain_16(invGain_Q30 *int32, A_16 [2][16]int32, order int32) int32 {
	...
	*invGain_Q30 = 1 << 30
	for k := int32(int64(order) - 1); k > 0; k-- {
		...
		rc_Q31 = -(*(*int32)(unsafe.Add(unsafe.Pointer(Anew_16), unsafe.Sizeof(int32(0))*uintptr(k))) << (31 - 16))
		...
		*invGain_Q30 = SKP_SMMUL(*invGain_Q30, rc_mult1_Q30) << 2
		...
		rc_mult2_Q16 = int32(rc_mult2_Q16 << headrm)
		for n := 0; n < int(k); n++ {
			...
			*(*int32)(unsafe.Add(unsafe.Pointer(Anew_16), unsafe.Sizeof(int32(0))*uintptr(n))) = int32(SKP_SMMUL(tmp_16, rc_mult2_Q16) << (16 - int64(headrm)))
		}
	}
	...
	rc_Q31 = -(*(*int32)(unsafe.Add(unsafe.Pointer(Anew_16), unsafe.Sizeof(int32(0))*0)) << (31 - 16))
	rc_mult1_Q30 = int32((SKP_int32_MAX >> 1) - int64(SKP_SMMUL(rc_Q31, rc_Q31)))
	*invGain_Q30 = SKP_SMMUL(*invGain_Q30, rc_mult1_Q30) << 2
	return 0
}
func SKP_Silk_LPC_inverse_pred_gain(invGain_Q30 *int32, A_Q12 []int16, order int32) int32 {
	...
	for k := int32(0); int64(k) < int64(order); k++ {
		*(*int32)(unsafe.Add(unsafe.Pointer(Anew_16), unsafe.Sizeof(int32(0))*uintptr(k))) = int32(A_Q12[k] << (16 - 12))
	}
...
func SKP_Silk_LPC_inverse_pred_gain_Q24(invGain_Q30 *int32, A_Q24 []int32, order int32) int32 {
	...
	for k := int32(0); k < order; k++ {
		*(*int32)(unsafe.Add(unsafe.Pointer(Anew_16), unsafe.Sizeof(int32(0))*uintptr(k))) = SKP_RSHIFT_ROUND(A_Q24[k], 24-16)
	}
	return LPC_inverse_pred_gain_16(invGain_Q30, Atmp_16, order)
}
