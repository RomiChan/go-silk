...
func SKP_Silk_VQ_WMat_EC_FIX(ind *int32, rate_dist_Q14 *int32, in_Q14 *int16, W_Q18 *int32, cb_Q14 *int16, cl_Q6 *int16, mu_Q8 int32, L int32) {
	...
	*rate_dist_Q14 = SKP_int32_MAX
	cb_row_Q14 = cb_Q14
	for k = 0; k < L; k++ {
		diff_Q14[0] = *(*int16)(unsafe.Add(unsafe.Pointer(in_Q14), unsafe.Sizeof(int16(0))*0)) - *(*int16)(unsafe.Add(unsafe.Pointer(cb_row_Q14), unsafe.Sizeof(int16(0))*0))
		diff_Q14[1] = *(*int16)(unsafe.Add(unsafe.Pointer(in_Q14), unsafe.Sizeof(int16(0))*1)) - *(*int16)(unsafe.Add(unsafe.Pointer(cb_row_Q14), unsafe.Sizeof(int16(0))*1))
		diff_Q14[2] = *(*int16)(unsafe.Add(unsafe.Pointer(in_Q14), unsafe.Sizeof(int16(0))*2)) - *(*int16)(unsafe.Add(unsafe.Pointer(cb_row_Q14), unsafe.Sizeof(int16(0))*2))
		diff_Q14[3] = *(*int16)(unsafe.Add(unsafe.Pointer(in_Q14), unsafe.Sizeof(int16(0))*3)) - *(*int16)(unsafe.Add(unsafe.Pointer(cb_row_Q14), unsafe.Sizeof(int16(0))*3))
		diff_Q14[4] = *(*int16)(unsafe.Add(unsafe.Pointer(in_Q14), unsafe.Sizeof(int16(0))*4)) - *(*int16)(unsafe.Add(unsafe.Pointer(cb_row_Q14), unsafe.Sizeof(int16(0))*4))
