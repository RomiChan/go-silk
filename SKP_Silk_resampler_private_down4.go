...
func SKP_Silk_resampler_private_down4(S *int32, out *int16, in *int16, inLen int32) {
	...
	for k = 0; k < len4; k++ {
		in32 = ((int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(k*4))))) + (int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(k*4+1)))))) << 9
		...
		*(*int32)(unsafe.Add(unsafe.Pointer(S), unsafe.Sizeof(int32(0))*0)) = in32 + X
		in32 = ((int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(k*4+2))))) + (int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(k*4+3)))))) << 9
