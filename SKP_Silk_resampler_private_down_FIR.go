...
func SKP_Silk_resampler_private_down_FIR_INTERPOL0(out *int16, buf2 *int32, FIR_Coefs *int16, max_index_Q16 int32, index_increment_Q16 int32) *int16 {
	...
	for index_Q16 = 0; index_Q16 < max_index_Q16; index_Q16 += index_increment_Q16 {
		buf_ptr = (*int32)(unsafe.Add(unsafe.Pointer(buf2), unsafe.Sizeof(int32(0))*uintptr(index_Q16>>16)))
		res_Q6 = SKP_SMULWB((*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*0)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*11))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*0))))
		res_Q6 = SKP_SMLAWB(res_Q6, (*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*1)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*10))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*1))))
		res_Q6 = SKP_SMLAWB(res_Q6, (*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*2)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*9))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*2))))
		res_Q6 = SKP_SMLAWB(res_Q6, (*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*3)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*8))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*3))))
		res_Q6 = SKP_SMLAWB(res_Q6, (*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*4)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*7))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*4))))
		res_Q6 = SKP_SMLAWB(res_Q6, (*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*5)))+(*(*int32)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int32(0))*6))), int32(*(*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*5))))
		*func() *int16 {
			p := &out
			x := *p
...
func SKP_Silk_resampler_private_down_FIR_INTERPOL1(out *int16, buf2 *int32, FIR_Coefs *int16, max_index_Q16 int32, index_increment_Q16 int32, FIR_Fracs int32) *int16 {
	...
	for index_Q16 = 0; index_Q16 < max_index_Q16; index_Q16 += index_increment_Q16 {
		...
		interpol_ptr = (*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*uintptr(RESAMPLER_DOWN_ORDER_FIR/2*interpol_ind)))
		...
		interpol_ptr = (*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*uintptr(RESAMPLER_DOWN_ORDER_FIR/2*(FIR_Fracs-1-interpol_ind))))
