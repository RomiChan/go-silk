...
func SKP_Silk_resampler_private_down_FIR_INTERPOL0(out *int16, buf2 *int32, FIR_Coefs []int16, max_index_Q16 int32, index_increment_Q16 int32) *int16 {
	...
	for index_Q16 = 0; index_Q16 < max_index_Q16; index_Q16 += index_increment_Q16 {
		buf_ptr = ([]int32)((*int32)(unsafe.Add(unsafe.Pointer(buf2), unsafe.Sizeof(int32(0))*uintptr(index_Q16>>16))))
...
func SKP_Silk_resampler_private_down_FIR_INTERPOL1(out *int16, buf2 *int32, FIR_Coefs *int16, max_index_Q16 int32, index_increment_Q16 int32, FIR_Fracs int32) *int16 {
	...
	for index_Q16 = 0; index_Q16 < max_index_Q16; index_Q16 += index_increment_Q16 {
		...
		interpol_ptr = ([]int16)((*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*uintptr(RESAMPLER_DOWN_ORDER_FIR/2*interpol_ind))))
		...
		interpol_ptr = ([]int16)((*int16)(unsafe.Add(unsafe.Pointer(FIR_Coefs), unsafe.Sizeof(int16(0))*uintptr(RESAMPLER_DOWN_ORDER_FIR/2*(FIR_Fracs-1-interpol_ind)))))
...
func SKP_Silk_resampler_private_down_FIR(SS unsafe.Pointer, out []int16, in []int16, inLen int32) {
	...
	for {
		...
		if S.FIR_Fracs == 1 {
			out = ([]int16)(SKP_Silk_resampler_private_down_FIR_INTERPOL0(&out[0], &buf2[0], ([]int16)(FIR_Coefs), max_index_Q16, index_increment_Q16))
		} else {
