...
func SKP_Silk_resampler_down2(S *int32, out *int16, in *int16, inLen int32) {
	var (
		k     int32
		len2  int32 = int32(int64(inLen) >> 1)
		in32  int32
		out32 int32
		Y     int32
		X     int32
	)
	for k = 0; int64(k) < int64(len2); k++ {
		in32 = int32(int64(int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(int64(k)*2))))) << 10)
		...
		*(*int32)(unsafe.Add(unsafe.Pointer(S), unsafe.Sizeof(int32(0))*0)) = int32(int64(in32) + int64(X))
		in32 = int32(int64(int32(*(*int16)(unsafe.Add(unsafe.Pointer(in), unsafe.Sizeof(int16(0))*uintptr(int64(k)*2+1))))) << 10)
