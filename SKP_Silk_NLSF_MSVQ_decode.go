...
func SKP_Silk_NLSF_MSVQ_decode(pNLSF_Q15 *int32, psNLSF_CB *SKP_Silk_NLSF_CB_struct, NLSFIndices *int32, LPC_order int32) {
	...
	pCB_element = (*int16)(unsafe.Add(unsafe.Pointer((*(*SKP_Silk_NLSF_CBS)(unsafe.Add(unsafe.Pointer(psNLSF_CB.CBStages), unsafe.Sizeof(SKP_Silk_NLSF_CBS{})*0))).CB_NLSF_Q15), unsafe.Sizeof(int16(0))*uintptr((*(*int32)(unsafe.Add(unsafe.Pointer(NLSFIndices), unsafe.Sizeof(int32(0))*0)))*LPC_order)))
	...
	for s = 1; s < psNLSF_CB.NStages; s++ {
		if LPC_order == 16 {
			pCB_element = (*int16)(unsafe.Add(unsafe.Pointer((*(*SKP_Silk_NLSF_CBS)(unsafe.Add(unsafe.Pointer(psNLSF_CB.CBStages), unsafe.Sizeof(SKP_Silk_NLSF_CBS{})*uintptr(s)))).CB_NLSF_Q15), unsafe.Sizeof(int16(0))*uintptr((*(*int32)(unsafe.Add(unsafe.Pointer(NLSFIndices), unsafe.Sizeof(int32(0))*uintptr(s))))<<4)))
