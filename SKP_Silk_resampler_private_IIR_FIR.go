...
func SKP_Silk_resampler_private_IIR_FIR_INTERPOL(out *int16, buf *int16, max_index_Q16 int32, index_increment_Q16 int32) *int16 {
	...
	for index_Q16 = 0; int64(index_Q16) < int64(max_index_Q16); index_Q16 += index_increment_Q16 {
		table_index = SKP_SMULWB(int32(int64(index_Q16)&math.MaxUint16), 144)
		buf_ptr = (*int16)(unsafe.Add(unsafe.Pointer(buf), unsafe.Sizeof(int16(0))*uintptr(int64(index_Q16)>>16)))
		...
		res_Q15 = SKP_SMLABB(res_Q15, int32(*(*int16)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int16(0))*3))), int32(SKP_Silk_resampler_frac_FIR_144[143-int64(table_index)][2]))
		res_Q15 = SKP_SMLABB(res_Q15, int32(*(*int16)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int16(0))*4))), int32(SKP_Silk_resampler_frac_FIR_144[143-int64(table_index)][1]))
		res_Q15 = SKP_SMLABB(res_Q15, int32(*(*int16)(unsafe.Add(unsafe.Pointer(buf_ptr), unsafe.Sizeof(int16(0))*5))), int32(SKP_Silk_resampler_frac_FIR_144[143-int64(table_index)][0]))
		*func() *int16 {
			p := &out
			x := *p
			*p = (*int16)(unsafe.Add(unsafe.Pointer(*p), unsafe.Sizeof(int16(0))*1))
			return x
		}() = SKP_SAT16(int16(SKP_RSHIFT_ROUND(res_Q15, 15)))
	}
	return out
}
func SKP_Silk_resampler_private_IIR_FIR(SS unsafe.Pointer, out []int16, in []int16, inLen int32) {
	...
	for {
		...
		max_index_Q16 = int32(int64(nSamplesIn) << (int64(S.Input2x) + 16))
		out = ([]int16)(SKP_Silk_resampler_private_IIR_FIR_INTERPOL(&out[0], &buf[0], max_index_Q16, index_increment_Q16))
		in += ([]int16)(nSamplesIn)
		inLen -= nSamplesIn
		if int64(inLen) > 0 {
			memcpy(unsafe.Pointer(&buf[0]), unsafe.Pointer(&buf[int64(nSamplesIn)<<int64(S.Input2x)]), size_t(RESAMPLER_ORDER_FIR_144*unsafe.Sizeof(int32(0))))
		} else {
			break
		}
	}
	memcpy(unsafe.Pointer(&S.SFIR[0]), unsafe.Pointer(&buf[int64(nSamplesIn)<<int64(S.Input2x)]), size_t(RESAMPLER_ORDER_FIR_144*unsafe.Sizeof(int32(0))))
}
