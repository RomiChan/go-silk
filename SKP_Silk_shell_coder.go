...
func SKP_Silk_shell_decoder(pulses0 []int32, sRC *SKP_Silk_range_coder_state, pulses4 int32) {
	...
	decode_split(&pulses3[0], &pulses3[1], sRC, pulses4, &SKP_Silk_shell_code_table3[0])
	decode_split(&pulses2[0], &pulses2[1], sRC, pulses3[0], &SKP_Silk_shell_code_table2[0])
	decode_split(&pulses1[0], &pulses1[1], sRC, pulses2[0], &SKP_Silk_shell_code_table1[0])
	decode_split(&pulses0[0], &pulses0[1], sRC, pulses1[0], &SKP_Silk_shell_code_table0[0])
