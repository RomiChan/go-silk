...
func SKP_ROR32(a32 int32, rot int32) int32 {
	...
	if int64(rot) <= 0 {
		return int32((int64(x) << int64(m)) | int64(x)>>(32-int64(m)))
	} else {
		return int32((int64(x) << (32 - int64(r))) | int64(x)>>int64(r))
	}
}
func SKP_SMULTT(a32 int32, b32 int32) int32 {
	return int32((int64(a32) >> 16) * (int64(b32) >> 16))
}
func SKP_SMLATT(a32 int32, b32 int32, c32 int32) int32 {
	return int32(int64(a32) + (int64(b32)>>16)*(int64(c32)>>16))
}
func SKP_SAT16(a int16) int16 {
	if int64(a) > SKP_int16_MAX {
		return SKP_int16_MAX
	}
	if int64(a) < int64(math.MinInt16) {
		return math.MinInt16
	}
	return a
}
func SKP_SAT32(a int32) int32 {
	if int64(a) > SKP_int32_MAX {
		return SKP_int32_MAX
	}
	if int64(a) < int64(math.MinInt32) {
		return math.MinInt32
	}
	return a
}
func SKP_ADD_POS_SAT32(a int32, b int32) int32 {
	if ((int64(a) + int64(b)) & 0x80000000) != 0 {
		return SKP_int32_MAX
	}
...
func SKP_RSHIFT_ROUND(a int32, shift int32) int32 {
	if int64(shift) == 1 {
		return int32((int64(a) >> 1) + (int64(a) & 1))
	}
	return int32(((int64(a) >> (int64(shift) - 1)) + 1) >> 1)
}
...
func SKP_LIMIT_int(a int32, limit1 int32, limit2 int32) int32 {
	if int64(limit1) > int64(limit2) {
		if int64(a) > int64(limit1) {
			return limit1
		}
		if int64(a) < int64(limit2) {
			return limit2
		}
		return a
	}
